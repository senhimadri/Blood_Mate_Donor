    ...
    <div class="container" style="margin-top:40px;   "  >
      ...
      <?php include_once('partial/sidebar.php'); ?>
        ...
        <div class="col-lg-9 mb-4" >
             ...
             <div class="row">
<div class="col-sm-12">
  <h3 class="well">Groups Wher You Added</h3>
...
<?php 
      $con = connect();
      $re_id=$_SESSION['r_id'];
      $sql = "SELECT * FROM `groups`,`group_member` WHERE group_member.g_id=groups.g_id AND group_member.r_id='$re_id' AND group_member.accept='1' ORDER BY g_m_id DESC";
      ...
      <div class="panel-heading"> <h3><?=$prd['g_name']?></h3> 
       ...
       <a href="btn_see_member.php?g_id=<?= $prd['g_id'] ?>" class="btn btn-primary">See Members</a>
        ...
        <a href="btn_see_post.php?g4_id=<?= $prd['g_id'] ?>" class="btn btn-primary">See Posts</a>
         <a href="btn_live_group.php?g5_id=<?= $prd['g_id'] ?>" class="btn btn-primary">Live Group</a>
        </div>
