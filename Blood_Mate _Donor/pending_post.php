    ...
    <div class="container" style="margin-top:40px;   "  >
      ...
      <?php include_once('partial/sidebar.php'); ?>
        ...
        <div class="col-lg-9 mb-4" >
             ...
             <div class="row">
<div class="col-sm-12">
  <h3 class="well">Your Pending Post</h3>
...
<?php 
      $con = connect();
      $re_id=$_SESSION['r_id'];
      $sql = "SELECT * FROM `blog_post`,`registration` WHERE blog_post.r_id=registration.r_id AND blog_post.position='0' AND blog_post.r_id='$re_id' ORDER BY p_date DESC";
...
?>
  ...
  <?php while ($prd=mysqli_fetch_assoc($run_data)) {  ?>
      ...
      <div class="panel panel-default" >
       ...
       <a href="btn_pending_delete.php?p_id=<?= $prd['p_id'] ?>" class="btn btn-primary">Remove</a>
        </div>
